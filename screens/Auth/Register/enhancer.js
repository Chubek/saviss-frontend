...
const registerScreenEnhancer = Component => props => {
    ...
    return (
        <ImageBackground style={globalStyles.bg} source={Images.background}><Component {...props} setNumber={setNumber}
                                                                                       setBio={setBio}
